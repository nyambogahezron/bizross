			...
			<nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
				...
				<div className="hidden md:flex items-center gap-3">
					...
					<motion.a
						...
						whileTap={{ scale: 0.97 }}
						className="px-4 py-2 text-sm font-semibold text-foreground btn-primary rounded-lg transition-shadow duration-300"
					>
						Start Free Trial
					</motion.a>
				</div>
						...
						<div className="px-4 py-4 flex flex-col gap-1">
							{navLinks.map((link) => (
								<a
									...
									className="px-4 py-3 text-sm font-medium text-text-secondary hover:text-foreground hover:bg-surface-hover rounded-lg transition-all"
								>
									{link.label}
								</a>
							))}
